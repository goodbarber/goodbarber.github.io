...
for category_name in sorted(categories.keys(), key=custom_sort):
    ...
    for repo_data in sorted(
        ...
        #                 "href": "XXXXXXXXXXX",
        #                 "website": "XXXXXXXXXXXXXXX",
        #                 "description": "In-App Purchase represents nearly 50% of the revenue generated by native apps. Discover in-app purchases and their key features.Discover in-app purchases and their key features.Discover in-app purchases and their key features.",
        #             }
            #     else:
            #         name = repo_data["name"]
            #         repo = {
